...
import { getFeeTemplate, updateFeeTemplate } from '@/app/actions/fee-templates';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Edit Fee Template</h1>
          <p className="text-muted-foreground">Update the pricing template details</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Modify the details for this fee template.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
